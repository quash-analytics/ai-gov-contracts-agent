...
from jarvis.ops import browser_agent, commands, compare_history
from jarvis.ops.arena import (
    compare_clear,
    compare_delete_run,
    compare_regrade,
    compare_stream,
...
from jarvis.ops.browser_agent import agent_lock, dash_session, get_agent, maybe_rotate_session
from jarvis.ops.catalog import list_models
from jarvis.ops.pricing import price_for, usage_summary
from jarvis.ops.settings_api import apply_settings, pin_action, settings_info
from jarvis.ops.tracing import TraceEncodingError, iter_trace_lines
...
def tools_info() -> dict:
    ...
    if live is not None:
        ...
        if settings.experimental:
            ...
            # switch did nothing.
            from jarvis.tools import experimental as experimental_tools
...
def main() -> None:
    ...
    for port in range(base, base + 10):  # walk past a busy port instead of crashing
        ...
        from jarvis.gateway.discord import start_in_background as start_discord
        from jarvis.gateway.supervisor import GatewaySupervisor
        from jarvis.gateway.telegram import start_in_background as start_telegram
        from jarvis.gateway.whatsapp import start_in_background as start_whatsapp
        from jarvis.integrations import (
            INTEGRATIONS,
